...
class _$PostEntityImpl implements _PostEntity {
  ...
  @override
  String toString() {
    return 'PostEntity(id: $id, boardId: $boardId, writerNickname: $writerNickname, isWriterAnonymous: $isWriterAnonymous, title: $title, content: $content, viewCount: $viewCount, likeCount: $likeCount, commentCount: $commentCount, isSecret: $isSecret, isLiked: $isLiked, createdAt: $createdAt, updatedAt: $updatedAt, imageUrls: $imageUrls)';
  }
